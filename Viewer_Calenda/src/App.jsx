    ...
    <section className="card inline-participant-preview">
      <div className="card-header">
        ...
        <div className="participant-header-actions">
          <span className="participant-count-chip">{toKhmerNumeral(participants.length)} នាក់</span>
...
function getMeetingDraftDocument(meeting) {
  const draftDocument = meeting.id === 'm1'
    ? meeting.documents?.find((document) => document.id === 'd1' || document.url === '/docs/Q2_Strategy_Deck.pdf')
    : meetingDraftDocuments[meeting.id]

  return draftDocument ? normalizeDocument(draftDocument, meeting) : null
}
    ...
    <main className="page-content">
      ...
      <section className="card">
        <div className="card-header">
          ...
          <span className="participant-count-chip compact">{toKhmerNumeral(filteredParticipants.length)} / {toKhmerNumeral(participants.length)} នាក់</span>
        </div>
